 ...
 * @author TARPAN
 */
public class LaporanViews extends javax.swing.JFrame {

    /**
     * Creates new form LaporanViews
     */
    public LaporanViews() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanViews.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanViews().setVisible(true);
            }
        });
    }
